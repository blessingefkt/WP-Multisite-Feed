...
{
	const VALID_OPTIONS = [
		OptionsKeys::CACHE_EXPIRY,
		OptionsKeys::TITLE,
		OptionsKeys::DESCRIPTION,
		OptionsKeys::URL_SLUG,
		OptionsKeys::LANGUAGE_SLUG,
		OptionsKeys::MAX_ENTRIES,
		OptionsKeys::MAX_ENTRIES_PER_SITE,
		OptionsKeys::INCLUDED_BLOGS,
		OptionsKeys::EXCLUDED_BLOGS,
		OptionsKeys::USE_EXCERPT,
		OptionsKeys::USE_MORE,
	...
	public function save()
	{
		...
		foreach ($request as $requestKey => $value) {
			if (in_array($requestKey, self::VALID_OPTIONS)) {
				$options[$requestKey] = $value;
			}
		}
		return $this->settings->merge($options);
